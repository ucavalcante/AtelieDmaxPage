// JavaScript para página de detalhes do produto com carrossel
...
const ProductDetailApp = {
    setup() {
        ...
        const getCurrentImageData = () => {
            ...
            return state.imageDescriptions[key] || state.imageDescriptions[imageName] || {};
        };

        const handleImageError = (event) => {
            console.warn('Erro ao carregar imagem:', event.target.src);
            event.target.src = settings.fallbackImage;
        };
